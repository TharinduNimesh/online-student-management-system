                ...
                <div class="row">
                    <div class="col-12 col-lg-6 px-4 px-md-5 mt-4 text-light order-2 order-lg-1">
                        <p class="font-italic">At SchoolPlus, we understand the importance of education even in the face of
                            challenging
                            circumstances. As an online student management system, our platform aims to bridge the gap
                            between
                        ...
                        <p class="mb-4">
                            ...
                            ever.
                            Recognizing this need, we embarked on a mission to create a comprehensive student management
                            system
                            that
                    ...
                    <div class="col-12 col-lg-6 px-4 px-md-5 mt-4 text-light order-2">
                        ...
                        <ul>
                            <li class="my-2"><strong>Over 1,000,000 Students:</strong> We've touched the lives of over a
                                ...
                                management.</li>
                            <li class="my-2"><strong>Dedicated Teachers:</strong> Our platform is trusted by more than
                                50,000
                                teachers who rely on schoolPlus to enhance their teaching experience and connect with their
                                students effortlessly.</li>
                            <li class="my-2"><strong>98% User Satisfaction:</strong> With a remarkable 98% user
                                satisfaction
                                rate, our commitment to excellence reflects in every interaction, making schoolPlus a
                                trusted
                            ...
                            <li class="my-2"><strong>Government-Approved Solution:</strong> The Sri Lankan government has
                                officially recognized the quality and impact of our student management system. This
                                endorsement
                        ...
                        <div class="row features-container gap-4 px-3">
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    ...
                                    <p class="text-light mt-3">Simplify enrollment, track attendance, centralize records,
                                        and
                                        promote positive behavior tracking. Enhance student engagement, academic
                                        transparency,
                            ...
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    ...
                                    <p class="text-light mt-3">Efficiently manage teacher profiles, assign classes,
                                        facilitate
                                        communication, and access performance insights, enabling educators to focus on
                                        impactful
                            ...
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    ...
                                    <p class="text-light mt-3">Create assignments, track submissions, employ a user-friendly
                                        grading system, and foster effective feedback exchange, optimizing teaching
                                        efficiency
                            ...
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    ...
                                    <p class="text-light mt-3">Automate accurate grade calculation, visualize performance
                                        insights, generate comprehensive reports, and individualize progress tracking.
                                        Empower
                            ...
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    ...
                                    <p class="text-light mt-3">Effortlessly create and organize lesson notes, facilitating
                                        seamless sharing with students. Enhance teaching effectiveness and student learning
                                        by
                            ...
                            <div class="feature-box position-relative">
                                ...
                                <div class="row content text-center px-3">
                                    <h4>Data Security</h4>
                                    <p class="text-light mt-3">Implement robust user authentication, role-based access
                                        control,
                                        encryption measures, and regular data backups. Ensure data confidentiality,
                                        integrity,
                    ...
                    <div class="row px-2 py-3 px-lg-4">
                        <div class="col-12 col-md-6 mb-5 mb-lg-0">
                            ...
                            <p class="text-light font-italic">
                                <span class="text-primary" style="font-size: 20px">E</span>xperience limitless learning
                                with our student management system. Seamlessly adapt to virtual
                                classrooms,
                                evolve your skills, and excel in your education journey. Break free from boundaries and
                                unlock
                                your
